...
questions.map((item)=>{
    ...
    span2.addEventListener("click",()=>{
        if(span2.innerHTML==item.correct){
            ...
            span2.style.background="grey";
        }
    })
    span3.addEventListener("click",()=>{
        if(span3.innerHTML==item.correct){
            span3.style.background="green";
        }else{
            span3.style.background="grey";
        }
    })
    span4.addEventListener("click",()=>{
        if(span4.innerHTML==item.correct){
            span4.style.background="green";
        }else{
            span4.style.background="grey";
        }
    })
    ...
    div1.append(h3,span1,span2,span3,span4);
